...
public class CapacitationController {
	...
	@Autowired
	private RestCapacitationController restCapacitationController;

	@RequestMapping("/list-capacitations")
	public String getAllCapacitations(Model model) {
		logger.info("Getting all capacitations from api");
		List<Capacitation> capacitaciones = restCapacitationController.getCapacitations();
		model.addAttribute("capacitations", capacitaciones);
