...
<body>
	...
	<div class="container mt-5">
		...
		<div class="form-floating col-10 offset-1 col-md-6 offset-md-3 mt-4"
			...
			<select name="userType" class="form-select" id="floatingSelect"
				...
				<option id="type" value="administrative">Administrativo</option>
				<option id="type" value="client">Cliente</option>
				<option id="type" value="professional">Profesional</option>
	...
	<script src="<core:url value="/res/js/getUsersByType.js" />"></script>
