...
<body>
	...
	<div class="container mt-3">
		<div class="row justify-content-center">
			...
			<p
				class="text-center w-responsive mx-auto m-2 d-none d-sm-inline col-lg-8 col-md-10 col-xl-6">¿Tienes
				alguna pregunta? No dudes en contactarnos directamente. Nuestro
				equipo te responderá en cuestión de horas.</p>
					...
					<div class="custom-form-container">
						<form id="contact-form" name="contact-form"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="md-form mb-0">
										<label style="color: red">*</label> <label for="name" class="">Nombre:</label>
								...
								<div class="col-md-6">
									<div class="md-form mb-0">
										<label style="color: red">*</label> <label for="email"
											class="">Correo:</label> <small id="emailHelp"
							...
							<div class="row">
								<div class="col-md-12">
									<div class="md-form mb-0">
										<label style="color: red">*</label> <label for="subject"
